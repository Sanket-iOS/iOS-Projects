...
@interface TellPeopleViewController ()

@end

@implementation TellPeopleViewController
...
- (void)viewDidLoad {
   ...
   // [self.collectionview.backgroundView addSubview:imgVW];
    data=[NSMutableArray arrayWithObjects:@"Send Message",@"Share on Fb",@"Share on twitter",@"Tell By Mail",nil];
...
- (IBAction)btnback:(id)sender {
    UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Wish to Tell ?" delegate:self cancelButtonTitle:@"NO" otherButtonTitles:@"YES", nil];
    alert.tag = 50;
    [alert show];
}

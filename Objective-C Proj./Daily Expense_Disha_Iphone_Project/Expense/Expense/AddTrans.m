...

{
    ...
    if(tableView ==CategoryTable)
    {
        ...
        if(cell==nil)
        {
            ...
            cell.textLabel.text=[[Category objectAtIndex:indexPath.row]objectForKey:@"CNAME"];
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(tableView ==CategoryTable)
    {
        NSLog(@"%@",[Category objectAtIndex:indexPath.row]);
        CategoryBox.text=[[Category objectAtIndex:indexPath.row]objectForKey:@"CNAME"];
...
- (IBAction)SaveRecord:(id)sender
{
    ...
    if([str isEqualToString:@"YES"])
    {
        ...
        {
            NSString *insertQuery=[NSString stringWithFormat:@"insert into Trans(Item,Price,Category,TDate,Desc,Mode) Values('%@',%d,'%@','%@','%@','%@')",ItemBox.text,[PriceBox.text intValue],CategoryBox.text,DateTextBox.text,DescTextView.text,ModeTextBox.text];
